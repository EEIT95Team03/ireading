     ...
     <div class="col-sm-12 col-md-8">
        ...
        <div class="col-sm-12 col-md-4 rightbox">
           ...
           <h3>備註:</h3>
             ...
             <div class="text-center"><a type="button" class="btn btn-default btn-lg" href="<c:url value="/browse/cart/buyinfo"/>">
                   <span class="glyphicon glyphicon-shopping-cart" ></span>上一步</a>
                   <a class="btn btn-success btn-lg" href="<c:url value="/browse/cart/bill"/>">結帳，送出訂單<span class="glyphicon glyphicon-play"></span></a></div>
           </div>
          </div>
