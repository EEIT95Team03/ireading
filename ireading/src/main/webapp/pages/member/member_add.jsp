		...
		<div id="big-form" class="well auth-box">
			<div class="form-group">
				...
				<legend>會員資料</legend>
						...
						<div class="btn-group">
<!-- 							<a href="/pages/member_add.jsp" class="btn btn-default">新增會員資料</a> -->
...
<!-- 					</div> -->
						...
						<div class="form-group">
							<label class=" control-label" for="textinput2">帳號</label>
							<div class="">
								<input id="textinput2" type="text" name="account"
									value="${param.account}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>

						<div class="form-group">
							<label class=" control-label" for="textinput3">密碼</label>
							<div class="">
								<input id="textinput3" type="text" name="pwd"
									value="${param.pwd}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>

						<div class="form-group">
							<label class=" control-label" for="textinput4">姓名</label>
							<div class="">
								<input id="textinput4" type="text" name="MName"
									value="${param.MName}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>

						<div class="form-group">
							<label class=" control-label" for="textinput5">暱稱</label>
							<div class="">
								<input id="textinput5" type="text" name="nickName"
									value="${param.nickName}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>
						
						<div class="form-group">
							<label class=" control-label" for="radios">性別</label>
							<div class="">
								<div class="radio">
									<label for="radios-0">
									<input name="gender" id="radios-0" value="0" type="radio"
						...
						<div class="form-group">
							<label class=" control-label" for="textinput6">通訊地址</label>
							<div class="">
								<input id="textinput6" type="text" name="addr"
									value="${param.addr}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>

						<div class="form-group">
							<label class=" control-label" for="textinput7">手機</label>
							<div class="">
								<input id="textinput7" type="text" name="cell"
									value="${param.cell}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>
						
						<div class="form-group">
							<label class=" control-label" for="textinput8">出生日期</label>
							<div class="">
								<input id="textinput8" type="text" name="birthday"
									value="${param.birthday}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>
						
						<div class="form-group">
							<label class=" control-label" for="textinput9">註冊日期</label>
							<div class="">
								<input id="textinput9" type="text" name="regDate"
									value="${param.regDate}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>

						<div class="form-group">
							<label class=" control-label" for="textinput9">剩餘金額</label>
							<div class="">
								<input id="textinput11" type="text" name="income"
									value="${param.income}" class="form-control input-md">
								<span class="help-block"></span>
							</div>
						</div>

						<div class="form-group">
							<label class=" control-label" for="filebutton">會員照片</label>
							<div class="">
								<input type="file" id="filebutton" name="file" class="input-file">
							</div>
						</div>
